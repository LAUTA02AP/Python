import Actividad1,Actividad2,Actividad3,Actividad4

def main():
    print("Resolucion de Activades de la Guia 6")
    ...
    while True:
        ...
        if numero == 1:
            print("\n---Actividad 1---")
            Actividad1.calcularEdad()
        elif numero == 2:
            print("\n---Actividad 2---")
            Actividad2.dividir_numeros()
        elif numero == 3:
            print("\n---Actividad 3---")
            Actividad3.consultarParidad()
        elif numero == 4:
            print("\n---Actividad 4---")
            Actividad4.escribirNum()
        else:
            break
